        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Salons_Cinemas_CinemaId",
                        column: x => x.CinemaId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_CinemaToMovies_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CinemaToMovies_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShowTimes_Salons_SalonId",
                        column: x => x.SalonId,
                        principalTable: "Salons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservedSeats_Reservation_ReservationId",
            ...
            migrationBuilder.InsertData(
                table: "Cinemas",
                columns: new[] { "Id", "Address", "Name", "Rate", "ReservationCount" },
                values: new object[] { 1, "Tehran azadi", "Azadi", (byte)3, 0 });

            migrationBuilder.InsertData(
                table: "Cinemas",
                columns: new[] { "Id", "Address", "Name", "Rate", "ReservationCount" },
                values: new object[] { 2, "Tehran Sattari", "Kourosh", (byte)4, 0 });

            migrationBuilder.InsertData(
                table: "Salons",
                columns: new[] { "Id", "Capacity", "CinemaId", "Name" },
                values: new object[] { 1, 200, 1, "Salon 1" });

            migrationBuilder.InsertData(
                table: "Salons",
                columns: new[] { "Id", "Capacity", "CinemaId", "Name" },
                values: new object[] { 2, 300, 2, "Salon 2" });

            migrationBuilder.CreateIndex(
                name: "IX_CinemaToMovies_CinemaId",
                table: "CinemaToMovies",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_CinemaToMovies_MovieId",
                table: "CinemaToMovies",
                column: "MovieId");
